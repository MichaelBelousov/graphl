...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    <Layout pageTitle="Twin Sync Studio Privacy Policy" pageDesc="privacy policy terms for Twin Sync Studio">
...
Agreement at any time by contacting Us and requesting termination. Please keep in
mind that any outstanding fees will still be due even after termination of Your account. At
the termination of this Agreement, any provisions that would be expected to survive
