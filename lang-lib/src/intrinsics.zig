...
/// -1 if doesn't exist
export fn __grappl_string_indexof(str: GrapplString, chr: GrapplChar) i32 {
...
export fn __grappl_string_len(str: GrapplString) u32 {
    return str.len;
}
...
// fixed types
export fn __grappl_max(a: i32, b: i32) i32 {
    return @max(a, b);
}
export fn __grappl_min(a: i32, b: i32) i32 {
    return @min(a, b);
}
